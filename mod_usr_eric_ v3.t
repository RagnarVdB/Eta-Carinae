...
contains
  ...
  subroutine usr_init()
    ...
    !v2.1 change: changed to polar_2D instead of polar
  ...
  subroutine initonegrid_usr(ixI^L,ixO^L,w,x)
    ...
    !V2.1: instead try out primitive version
  ...
  !   x:     Cell coords
    ...
    !V2.1: primitve used instead of conserved
    !call hd_to_conserved(ixI^L,ixO^L,w,x)
    call hd_to_primitive(ixI^L,ixO^L,w,x)
