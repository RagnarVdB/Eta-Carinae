...
contains
  ...
  !   x:     Cell coords
    ...
    !Standard wind
    !Note that unit time rn is in seconds, and the number should be 507 years
    if (qt .ge. 0 .AND. qt .le. 507/unit_time*(365.25*24*60*60))  then
    ...
    !Pre-outburst wind
    else if (qt .ge. 507/unit_time*(365.25*24*60*60) .AND. qt .le. (507+20)/unit_time*(365.25*24*60*60))  then
    ...
    !Explosion
    else if (qt .ge. (507+20)/unit_time*(365.25*24*60*60) .AND. qt .le. (507+20+1)/unit_time*(365.25*24*60*60))  then
    ...
    !Post-outburst wind
    else if (qt .ge. (507+20+1)/unit_time*(365.25*24*60*60) .AND. qt .le. (507+20+1+49)/unit_time*(365.25*24*60*60))  then
      MassPerTime=SolarMass*1.0d-3                                           
      MassPerTime=MassPerTime*unit_time/(unit_mass*365.25*24*60*60)
      !This thing is technically not needed anymore
      vel0A=4.0d2*1.d5/unit_velocity      ! inner velocity A        =250   km/s, convert cms, then units
    ...
    !Minor explosion
    else if (qt .ge. (507+20+1+49)/unit_time*(365.25*24*60*60) .AND. qt .le. (507+20+1+49+10)/unit_time*(365.25*24*60*60))  then
    ...
    else if (qt .ge. (507+20+1+49+10)/unit_time*(365.25*24*60*60) .AND. qt .le. (507+20+1+49+10+120)/unit_time*(365.25*24*60*60))  then
      MassPerTime=SolarMass*1.0d-3                                           
      MassPerTime=MassPerTime*unit_time/(unit_mass*365.25*24*60*60)
      !This thing is technically not needed anymore
      vel0A=4.0d2*1.d5/unit_velocity      ! inner velocity A        =250   km/s, convert cms, then units
